...
-- 1. Add transfer_link_id to transactions
ALTER TABLE public.transactions 
ADD COLUMN IF NOT EXISTS transfer_link_id UUID;

-- 2. Create RPC for atomic transfers
CREATE OR REPLACE FUNCTION public.perform_transfer(
  ...
  p_description TEXT,
  p_currency TEXT,
  p_converted_amount NUMERIC, -- The amount in the TO currency
  p_to_currency TEXT
)
...
BEGIN
  ...
  INSERT INTO public.transactions (
    ...
    name,
    amount, -- Text display
    "numericAmount", -- The actual number
    currency,
    date,
    category,
    type,
    ...
    to_char(p_amount, 'FM999,999,999.00'), -- Simple formatting, frontend should ideally parse this
    p_amount, 
    p_currency,
    p_date,
    'Transfer',
