...
export const TRANSLATIONS = {
  en: {
    ...
    cashflow: {
      ...
      savingsRateDesc: '(Savings + Investment) / Net Income',
      dtiLabel: 'Debt-to-Income (DTI)',
      dtiDesc: 'Monthly Debt Payments / Net Income',
      liquidityLabel: 'Liquidity Months',
      liquidityDesc: 'Liquid Assets / Monthly Expenses',
      assetsTitle: 'Asset Registry',
      liabilitiesTitle: 'Liabilities & Debts',
      ...
      addFirstAsset: 'Register your first asset to start tracking',
      noLiabilities: 'No liabilities registered',
      debtFree: 'Debt-free status!',
      totalBalance: 'Total Balance',
      totalMonthly: 'Monthly Payments',
      ...
      depreciation: 'Depreciation Rate/Yr (%)',
      acquisitionDate: 'Acquisition Date',
      notes: 'Notes',
      liabilityName: 'Liability Name',
      liabilityType: 'Liability Type',
      expenseClass: 'Expense Classification',
      currentBalance: 'Current Balance',
      monthlyPaymentLabel: 'Monthly Payment',
      interestRate: 'Interest Rate (APR %)',
      remainingTerm: 'Remaining Term (Months)',
      startDate: 'Start Date',
      hasCollateral: 'Has Collateral / Guarantee',
      collateralDesc: 'Is this debt backed by an asset?',
      statusAlarm: '⚠️ Below Target',
      statusSolid: '✅ Solid',
      statusAcceleration: '🚀 Acceleration',
      statusHighPressure: '🔴 High Pressure',
      statusAcceptable: '🟡 Acceptable',
      statusRoom: '🟢 Room Available',
      statusCritical: '🚨 Critical Risk',
      statusHighRisk: '🔴 High Risk',
      statusHealthy: '🟡 Healthy',
      statusUltraDefensive: '🛡️ Ultra-Defensive',
    },
    dashboard: {
      netWorth: 'Net Worth',
  ...
  es: {
    ...
    titles: {
      ...
      cashFlow: 'Control de Flujo de Caja',
    ...
    cashflow: {
      ...
      cashFlow: 'Flujo de Caja',
      savingsInvestment: 'Ahorro + Inversión',
      debtPayments: 'Pagos de Deuda',
      savingsRateLabel: 'Tasa de Ahorro',
      savingsRateDesc: '(Ahorro + Inversión) / Ingreso Neto',
      dtiLabel: 'Deuda/Ingreso (DTI)',
      dtiDesc: 'Pagos Mensuales de Deuda / Ingreso Neto',
      liquidityLabel: 'Meses de Liquidez',
      liquidityDesc: 'Activos Líquidos / Gastos Mensuales',
      assetsTitle: 'Registro de Activos',
      liabilitiesTitle: 'Pasivos y Deudas',
      registered: 'registrados',
      byType: 'Por Tipo',
      byClass: 'Por Clasificación',
      addAsset: 'Agregar Activo',
      addLiability: 'Agregar Pasivo',
      noAssets: 'No hay activos registrados',
      addFirstAsset: 'Registra tu primer activo para comenzar',
      noLiabilities: 'No hay pasivos registrados',
      debtFree: '¡Libre de deudas!',
      totalBalance: 'Saldo Total',
      totalMonthly: 'Pagos Mensuales',
      avgRate: 'Tasa Prom. Interés',
      balance: 'Saldo',
      monthly: 'Mensual',
      rateLabel: 'Tasa',
      term: 'Plazo',
      guaranteed: 'Respaldado',
      newAsset: 'Nuevo Activo',
      editAsset: 'Editar Activo',
      newLiability: 'Nuevo Pasivo',
      editLiability: 'Editar Pasivo',
      ...
      depreciation: 'Tasa Depreciación/Año (%)',
      acquisitionDate: 'Fecha de Adquisición',
      notes: 'Notas',
      liabilityName: 'Nombre del Pasivo',
      liabilityType: 'Tipo de Pasivo',
      expenseClass: 'Clasificación de Gasto',
      currentBalance: 'Saldo Actual',
      monthlyPaymentLabel: 'Cuota Mensual',
      interestRate: 'Tasa de Interés (APR %)',
      remainingTerm: 'Plazo Restante (Meses)',
      startDate: 'Fecha de Inicio',
      hasCollateral: 'Tiene Garantía / Respaldo',
      collateralDesc: '¿Esta deuda está respaldada por un activo?',
      statusAlarm: '⚠️ Por Debajo',
      statusSolid: '✅ Sólido',
      statusAcceleration: '🚀 Aceleración',
      statusHighPressure: '🔴 Alta Presión',
      statusAcceptable: '🟡 Aceptable',
      statusRoom: '🟢 Espacio Disponible',
      statusCritical: '🚨 Riesgo Crítico',
      statusHighRisk: '🔴 Riesgo Alto',
      statusHealthy: '🟡 Saludable',
      statusUltraDefensive: '🛡️ Ultra-Defensivo',
    },
    dashboard: {
      netWorth: 'Patrimonio Neto',
