        ...
        return createPortal(
            <div id="report-print-portal" className="fixed inset-0 z-[200] bg-neutral-900/90 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto print:p-0 print:bg-white print:static print:block print:overflow-visible">
                ...
                <div className="print-reset">
                    ...
                    <div className="w-[210mm] min-h-[297mm] bg-white text-neutral-900 shadow-2xl p-[15mm] print:p-[10mm] print:shadow-none print:w-full print:min-h-0 print:h-auto animate-fade-in relative flex flex-col page-break-before">
                        ...
                        {/* Footer */}
                        <div className="mt-12 pt-8 border-t border-neutral-200 flex justify-between items-end text-[10px] text-neutral-400 print:mt-8">
                            <div>
