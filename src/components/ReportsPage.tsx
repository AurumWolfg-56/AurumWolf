        ...
        return createPortal(
            <div id="report-print-portal" className="fixed inset-0 z-[200] bg-neutral-900/90 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto print:p-0 print:bg-white print:static print:block print:overflow-visible">
                ...
                <div className="print-reset">
                    ...
                    <div className="w-[210mm] min-h-[297mm] bg-white text-neutral-900 shadow-2xl p-[15mm] print:p-[10mm] print:shadow-none print:w-full print:h-[297mm] print:min-h-0 animate-fade-in relative flex flex-col page-break-before overflow-hidden">

                        {/* SECTIONS */}
                        <div className="flex-1 print:scale-[0.95] print:origin-top">
                        ...
                        {/* Footer - Pinned for Print */}
                        <div className="mt-12 pt-8 border-t border-neutral-200 flex justify-between items-end text-[10px] text-neutral-400 print:absolute print:bottom-8 print:left-[10mm] print:right-[10mm] print:border-t">
                            <div>
