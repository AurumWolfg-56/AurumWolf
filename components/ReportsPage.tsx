...
export const ReportsPage: React.FC<ReportsPageProps> = ({
    ...
    const renderPreview = () => {
        ...
        return (
            <div className="fixed inset-0 z-[200] bg-neutral-900/90 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto print:p-0 print:bg-white print:static print:block">
                ...
                {/* A4 REPORT CANVAS */}
                <div className="w-[210mm] min-h-[297mm] bg-white text-neutral-900 shadow-2xl p-[15mm] print:shadow-none print:w-full print:h-auto animate-fade-in relative flex flex-col">
